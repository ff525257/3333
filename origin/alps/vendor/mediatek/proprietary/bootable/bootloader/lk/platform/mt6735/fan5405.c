...
//zhangchongyong 20160525 add start
#if defined(LYCONFIG_AUTO_PLATFORM_NAME_F300C) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F1C) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F300) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F300CS) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F1CS) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F300S)
#define FAN5405_I2C_ID	I2C2
#else
#define FAN5405_I2C_ID	I2C3
#endif
//zhangchongyong 20160525 add end
...
void fan5405_hw_init(void)
{
    ...
    #else
    fan5405_reg_config_interface(0x06,0xb7); // set ISAFE and HW CV point (4.34)
    #endif
    ...
    #else
    fan5405_reg_config_interface(0x06,0xb0); // set ISAFE
    #endif
