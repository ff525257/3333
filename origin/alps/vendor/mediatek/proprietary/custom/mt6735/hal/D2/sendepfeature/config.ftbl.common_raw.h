...
//                MtkCameraParameters::EFFECT_F1977 ,
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            //add by kevin for custom_pic_size 2016, 请调试驱动的同事或者软件同事，将对应的前后摄的宏和插值copy过去
            #if 0
            #if defined(LYCONFIG_FEA_FRONT_CAMERA_PIC_SIZE_5M) || defined(LYCONFIG_FEA_REAR_CAMERA_PIC_SIZE_5M)
                ,"2048x1536" //4:3 3M
                ,"2304x1296" //16:9 3M
                ,"2560x1440" //16:9 4M
                ,"2560x1920" //4:3 5M
            ...
            #if defined(LYCONFIG_FEA_FRONT_CAMERA_PIC_SIZE_8M) || defined(LYCONFIG_FEA_REAR_CAMERA_PIC_SIZE_8M)
                ,"3264x2448" //4:3 8M
                ,"3840x2160" //16:9 8M
            #endif

            #if defined(LYCONFIG_FEA_REAR_CAMERA_PIC_SIZE_13M)
                ,"4096x2304" //16:9 9.5M
                ,"3680x2768" //4：3 10M
                ,"4096x3072" //4:3 12M
                ,"4608x2592" //16:9 12M
            ...
            #endif
            #endif
            //add by kevin for custom_pic_size 2016 end
            )
        ),
    )
#endif
