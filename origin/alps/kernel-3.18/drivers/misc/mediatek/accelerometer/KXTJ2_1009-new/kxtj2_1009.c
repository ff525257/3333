...
static struct acc_hw kxtj_accel_cust = {
    .i2c_num = 2,
#if defined(LYCONFIG_AUTO_PLATFORM_NAME_F6) ||defined(LYCONFIG_AUTO_PLATFORM_NAME_F6B)|| defined(LYCONFIG_AUTO_PLATFORM_NAME_F6S) ||defined(LYCONFIG_AUTO_PLATFORM_NAME_F6BS)
    .direction = 6,  //3      
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_F2) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F2P)|| defined(LYCONFIG_AUTO_PLATFORM_NAME_F2S) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F2PS)
    .direction = 4,   
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_F5) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F5B) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F5C)|| defined(LYCONFIG_AUTO_PLATFORM_NAME_F5S) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F5BS) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F5CS)
    .direction = 3,    
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_F1) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F1C) ||  defined(LYCONFIG_AUTO_PLATFORM_NAME_F1S) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F1CS)
    .direction = 2,  
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_F300C) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F300) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F300CS) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F300S)
    .direction = 0,  
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_F200C) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F200)||  defined(LYCONFIG_AUTO_PLATFORM_NAME_F200CS) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F200S)
    .direction = 4,  
#else 
    .direction = 5,
#endif
...
static struct acc_hw *hw = &kxtj_accel_cust;

/* For  driver get cust info */
struct acc_hw *kxtj_get_cust_acc(void)
{
	return &kxtj_accel_cust;
}
       ...
       unsigned long arg)
{
    ...
    switch (cmd)
    {
        case COMPAT_GSENSOR_IOCTL_READ_SENSORDATA:
		    ...
		    err = file->f_op->unlocked_ioctl(file, GSENSOR_IOCTL_READ_SENSORDATA, (long unsigned int)arg32);
		    if (err){
...
static int __init kxtj2_1009_init(void)
{
	...
	//if (!hw)
	//	GSE_ERR("kxtj2_1009 get dts info fail\n");
