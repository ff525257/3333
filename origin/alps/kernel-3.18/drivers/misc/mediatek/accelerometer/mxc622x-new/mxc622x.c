...
static int MXC622X_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	#if defined(LYCONFIG_AUTO_PLATFORM_NAME_F200C_HZ_B3) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F200CS_HZ_B3)
...
#if defined(LYCONFIG_AUTO_PLATFORM_NAME_F200) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F200C) ||defined(LYCONFIG_AUTO_PLATFORM_NAME_F200S) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F200CS)
	obj->hw->direction = 6;
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_Z300) || defined(LYCONFIG_AUTO_PLATFORM_NAME_Z300A) ||  defined(LYCONFIG_AUTO_PLATFORM_NAME_Z300S) || defined(LYCONFIG_AUTO_PLATFORM_NAME_Z300AS)
	obj->hw->direction = 1;
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_Z5) || defined(LYCONFIG_AUTO_PLATFORM_NAME_Z5S)
	obj->hw->direction = 4;
#endif
