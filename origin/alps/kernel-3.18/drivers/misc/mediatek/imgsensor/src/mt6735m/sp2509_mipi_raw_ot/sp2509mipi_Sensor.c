...
#if defined(LYCONFIG_AUTO_PLATFORM_NAME_Z5)|| defined(LYCONFIG_AUTO_PLATFORM_NAME_Z5S)
    .checksum_value = 0x3ca80b08,        //checksum value for Camera Auto Test
#else
    .checksum_value = 0x3ca80b08,//0xf7375923,
#endif
    .pre = {
...
#if defined(LYCONFIG_COMB_CUST_PROJECT_NAME_F300CP_OT)
...
UINT32 SP2509MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    SP2509MIPI_RAW_SensorInit    */
