...
UINT32 OV9760_MAIN_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 GC5025MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);          //daili add 12-23
UINT32 GC2365MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 GC2375MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);          //daili add 11-21
...
#endif
#if defined(IMX219_MIPI_RAW) || defined(IMX219_MIPI_RAW_QZ)
...
#endif
#if defined(IMX149_MIPI_RAW) || defined(IMX149_MIPI_RAW_GQ)
...
#if defined(OV9760_MIPI_RAW) || defined(OV9760_MIPI_RAW_GQ)
...
#endif
#if defined(OV9762_MIPI_RAW) || defined(OV9762_MIPI_RAW_GQ)
...
#endif
/*GC*/
#if defined(GC8024_MIPI_RAW)||defined(GC8024_MIPI_RAW_F200C_HZ_B)
    {GC8024MIPI_SENSOR_ID, SENSOR_DRVNAME_GC8024_MIPI_RAW, GC8024MIPI_RAW_SensorInit},
#endif
#if defined(GC5025_MIPI_RAW)
    {GC5025MIPI_SENSOR_ID, SENSOR_DRVNAME_GC5025_MIPI_RAW,GC5025MIPI_RAW_SensorInit},			//daili add 12-23
#endif
#if defined(GC5024_MIPI_RAW)
    {GC5024_SENSOR_ID, SENSOR_DRVNAME_GC5024_MIPI_RAW,GC5024MIPI_RAW_SensorInit},
#endif
#if defined(GC5005_MIPI_RAW) || defined(GC5005_MIPI_RAW_OT)
...
#endif
#if defined(GC2375_MIPI_RAW)                                                    //daili add 
    {GC2375MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2375_MIPI_RAW,GC2375MIPI_RAW_SensorInit},    
#endif 
#if  defined(GC2365_MIPI_RAW) || defined(GC2365_MIPI_RAW_OT)
    {GC2365MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2365_MIPI_RAW,GC2365MIPI_RAW_SensorInit},
#endif
...
/*SP*/
#if defined(SP0A09_MIPI_RAW) || defined(SP0A09_MIPI_RAW_OT)
...
#endif
#if defined(SP2509_MIPI_RAW) || defined(SP2509_MIPI_RAW_OT)
    {SP2509_SENSOR_ID, SENSOR_DRVNAME_SP2509_MIPI_RAW, SP2509MIPI_RAW_SensorInit},
#endif
/*A*/
