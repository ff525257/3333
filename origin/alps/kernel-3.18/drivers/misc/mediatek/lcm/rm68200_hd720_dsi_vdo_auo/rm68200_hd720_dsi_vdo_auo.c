...
{0x1B, 1,{0x00}},// ESD  ERR0R REPOT

{0x1C, 1,{0x00}},//ESD  ERR0R REPOT  
...
#else
	params->dsi.mode   = SYNC_PULSE_VDO_MODE;//SYNC_EVENT_VDO_MODE;//BURST_VDO_MODE;//// four
#endif
...
LCM_DRIVER rm68200_dsi_vdo_auo_lcm_drv = 
{
    .name			= "rm68200_dsi_vdo_auo_lcm_drv",
