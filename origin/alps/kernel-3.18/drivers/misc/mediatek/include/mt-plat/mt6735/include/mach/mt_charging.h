...
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_1100_00_MA
#define AC_CHARGER_INPUT_CURRENT				CHARGE_CURRENT_1100_00_MA
#else
...
#if defined(LYCONFIG_COMB_CHARGER_IC_MTK_SM5414_SUPPORT) || defined(LYCONFIG_COMB_CHARGER_IC_MTK_SM5701_SUPPORT) || defined(LYCONFIG_COMB_CHARGER_IC_MTK_FAN5405_SUPPORT)
